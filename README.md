...
#### <li>📈 Software Engineer **@Microsoft (E+D Copilot Growth)**</li>
#### <li>💼  SWE Intern **@Microsoft'24**</li>
#### <li>🏆  National Runner Up **Flipkart Grid 5.0** (AIR 2)</li>
#### <li>🏆  Shortlisted for **Google Cloud X AMD Solving for India** Regionals</li>
#### <li>🏆  Track Winner(AI) **Navdhara'24** Hackathon (200+ teams)</li>
